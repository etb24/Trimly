...
function ShortItem({originalUrl, shortUrl, clickCount, createdDate}) {
        ...
        <div className='flex sm:flex-row flex-col sm:justify-between w-full sm:gap-0 gap-5 py-5'>
            <div className='flex-1 sm:space-y-1 max-w-full overflow-x-auto overflow-y-hidden'>
                <div className='text-slate-900 pb-1 sm:pb-0 flex items-center gap-2'>
                    ...
                    target ='_blank'
                    className='text-[17px] font-roboto font[600] text-linkColor'>
                        {subDomain + '/' + `${shortUrl}`}
                    </a>
                ...
                <div className='flex items-center gap-8 pt-6'>
                    <div className='flex gap-1 items-center font-semibold text-green-800'>
                        ...
                        <span className='text-[14px]'>{clickCount}</span>
            ...
            <div className={`${
                ...
                {analyticsData.length === 0 && (
                    <div className="absolute flex flex-col  justify-center sm:items-center items-end  w-full left-0 top-0 bottom-0 right-0 m-auto">
                        <h1 className=" text-slate-800 font-roboto sm:text-2xl text-[15px] font-bold mb-1">
